...
public class GetBetDetailRequestHandler : IRequestHandler<GetBetDetailQuery, GetBetDetailDto?>
{
    ...
    public async Task<GetBetDetailDto?> Handle(GetBetDetailQuery request, CancellationToken cancellationToken)
    {
